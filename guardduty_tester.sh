...
echo '***********************************************************************'
echo
sudo nmap -Pn -sT $BASIC_LINUX_TARGET
echo
echo '-----------------------------------------------------------------------'
echo
...
echo '***********************************************************************'
echo '* Test #3 - CryptoCurrency Mining Activity                            *'
...
echo '***********************************************************************'
echo '* Test #5 - Fake domain to prove that GuardDuty is working            *'
...
#echo
echo 'Test 3: Cryptocurrency Activity'
